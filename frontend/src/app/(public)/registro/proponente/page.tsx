    ...
    <>
      ...
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        <div className="bg-[#00304D] text-white px-6 py-4 rounded-xl flex items-center gap-3 mb-8 shadow-md">
          <Building2 size={22} />
          <h1 className="font-semibold text-lg">Registrarse como Proponente</h1>
          <span className="text-white/60 text-sm ml-1">— Empresa / Gremio / Asociación</span>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white border border-neutral-200 rounded-2xl shadow-sm p-8 flex flex-col gap-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-semibold text-neutral-700">Dígito Verificación</label>
              <input
                type="number"
          ...
          {/* Razón Social */}
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-semibold text-neutral-700">Razón Social *</label>
            <input
              type="text"
          ...
          {/* Sigla */}
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-semibold text-neutral-700">Sigla / Nombre corto</label>
            <input
              type="text"
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-1">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 bg-cerulean-500 hover:bg-cerulean-700 disabled:opacity-60 text-white font-semibold text-sm py-2.5 rounded-xl transition-colors flex items-center justify-center gap-2"
            >
